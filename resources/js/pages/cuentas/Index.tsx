...
export default function Index({ filters, lista, estados }: any) {
	const {
		data,
		meta: { total, current_page, per_page },
	} = lista;

	const { id, show, processing, onToggleModal, onReload, onTrash, onStore, onGetItem, onSetItem } = useCrudPage(lista, (params: any) => ({ url: route('api.cuentas.destroy', { cuenta: params.id }) }));
	...
	return (
		<AppLayout breadcrumbs={breadcrumbs}>
			...
			<div className="flex items-end justify-between px-4 pt-4">
				<Search filters={filters} ruta="cuentas" />
