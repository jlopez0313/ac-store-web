...
import { Edit, ExternalLink, Image as ImageIcon, Package, RefreshCcw, Search, Tag, Trash, Warehouse } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <Card className="flex min-w-0 flex-col overflow-hidden border-slate-200 shadow-sm dark:border-slate-700">
                <CardContent className="custom-scrollbar max-h-[calc(100vh-5rem)] w-full max-w-full min-w-0 flex-1 overflow-x-auto overflow-y-auto p-0">
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="w-28 font-bold text-slate-700 dark:text-slate-300">Marca</TableHead>
                                <TableHead className="w-20 font-bold text-slate-700 dark:text-slate-300 text-center">Talla</TableHead>
                                <TableHead className="w-48 font-bold text-slate-700 dark:text-slate-300">Ubicación</TableHead>
                                <TableHead className="w-16 font-bold text-slate-700 dark:text-slate-300 text-center">Cant.</TableHead>
                                <TableHead className="w-40 font-bold text-slate-700 dark:text-slate-300">Precio</TableHead>
                                <TableHead className="w-32 font-bold text-slate-700 dark:text-slate-300 text-right">Subtotal</TableHead>
                        ...
                        <TableBody>
                            {filteredDetalles.map((detalle: any) => (
                                ...
                                >
                                    ...
                                    <TableCell>
                                        <div className="flex items-center gap-1.5 text-[10px] font-bold tracking-widest text-slate-500 uppercase dark:text-slate-400">
                                    ...
                                    <TableCell className="text-center">
                                        <span className="rounded-md bg-slate-100 px-2 py-0.5 text-[11px] font-black text-slate-700 dark:bg-slate-800 dark:text-slate-300">
                                            {detalle.talla}
                                        </span>
                                    </TableCell>
                                    <TableCell>
